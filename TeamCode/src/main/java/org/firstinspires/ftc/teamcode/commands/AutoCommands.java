    ...
    */
    public static Command blueAuto(Subsystems subsystems) {
        return Commands.sequence(
                Shooter.setPower(subsystems.shooter(), () -> -0.73).withTimeout(0.5),
                DriveCommands.strafeLeft(subsystems.drive(), 4),
                DriveCommands.backward(subsystems.drive(), 4),
                DriveCommands.turn(subsystems.drive(), -35),
                DriveCommands.backward(subsystems.drive(), 65),

                Intake.setPower(subsystems.intake(), () -> 0.4).withTimeout(3.0),
                Shooter.setPower(subsystems.shooter(), () -> 0).withTimeout(0.1),
                DriveCommands.forward(subsystems.drive(), 11),
                DriveCommands.turn(subsystems.drive(),-150),
                DriveCommands.forward(subsystems.drive(), 30),
                Intake.setPower(subsystems.intake(), () -> 0.35).withTimeout(1.5),
                Shooter.setPower(subsystems.shooter(), () -> 0.3).withTimeout(0.8),
                Intake.setPower(subsystems.intake(), () -> -0.25).withTimeout(0.6),
                Shooter.setPower(subsystems.shooter(), () -> 0).withTimeout(0.1),
                Intake.setPower(subsystems.intake(), () -> 0).withTimeout(0.1),
                DriveCommands.backward(subsystems.drive(), 30),
                DriveCommands.turn(subsystems.drive(), 150),
                Shooter.setPower(subsystems.shooter(), () -> 0.73).withTimeout(1.5),
                Intake.setPower(subsystems.intake(), () -> 0.6).withTimeout(0.8)


        );
    }
public static double red_ball= 90;
    public static Command redAuto(Subsystems subsystems) {
        return Commands.sequence(
                Shooter.setPower(subsystems.shooter(), () -> -0.7).withTimeout(0.5),
                DriveCommands.strafeLeft(subsystems.drive(), -4),
                DriveCommands.backward(subsystems.drive(), 4),
                DriveCommands.turn(subsystems.drive(), 37),
                DriveCommands.backward(subsystems.drive(), 65),
                Intake.setPower(subsystems.intake(), () -> 0.4).withTimeout(3.0),
                Shooter.setPower(subsystems.shooter(), () -> 0).withTimeout(0.1),
                DriveCommands.forward(subsystems.drive(), 11),
                DriveCommands.turn(subsystems.drive(),  red_ball),
                Intake.setPower(subsystems.intake(), () -> 0.35).withTimeout(0),
                DriveCommands.forward(subsystems.drive(), 27),
                Shooter.setPower(subsystems.shooter(), () -> 0.3).withTimeout(0.0),
                Intake.setPower(subsystems.intake(), () -> -0.25).withTimeout(0.3),
