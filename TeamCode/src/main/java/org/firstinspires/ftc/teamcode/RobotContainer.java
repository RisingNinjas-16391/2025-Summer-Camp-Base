...
//
        driverController.rightTrigger().onTrue(Intake.setPower(intake, 1.0)).onFalse(Intake.setPower(intake, 0.0));
        driverController.leftTrigger().onTrue(Intake.setPower(intake, -1.0)).onFalse(Intake.setPower(intake, 0.0));
//
