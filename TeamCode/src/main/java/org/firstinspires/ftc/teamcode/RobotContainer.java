...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
        ...
        driverController.rightBumper().onTrue(Pivot.score(pivot).andThen(Intake.setPower(intake, 0.5)));

        driverController.leftTrigger().onTrue(Intake.setPower(intake, 0.5)).onFalse(Intake.setPower(intake, 0.0));
        driverController.rightTrigger().onTrue(Intake.setPower(intake, -0.5));

        driverController.start().onTrue(Pivot.resetPosition(pivot)).onFalse(Intake.setPower(intake, 0.0));
    }
