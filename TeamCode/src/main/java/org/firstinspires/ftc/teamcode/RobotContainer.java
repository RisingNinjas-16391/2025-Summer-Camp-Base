...
//
        driverController.leftTrigger().onTrue(Intake.setPower(intake, 0.8)).onFalse(Intake.setPower(intake, 0.0));
        driverController.rightTrigger().onTrue(Intake.setPower(intake, -0.6)).onFalse(Intake.setPower(intake, 0.0));
//
